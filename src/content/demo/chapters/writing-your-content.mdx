...
<HtmlEmbed frameless skipGallery src="demo/content-structure.html" /> 
...
<MyChapter />
```
<small className="muted">You can see a living example here <a target="_blank" href="https://huggingface.co/spaces/tfrere/research-article-template/blob/main/app/src/content/chapters/best-practices.mdx">app/src/content/chapters/best-practices.mdx</a>.</small>
